		    ...
		    for(int gamma1 = 0 ;gamma1 < 4 ;gamma1++)
               for(int cc1=0;cc1<6;cc1++)
               {
                  ...
                  ////////// delta_plus_plus ///////////////////////////////////////////////////
                        ...
                        block[8][gamma*4+gamma1][v3] = qcd_CSUB( block[8][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[8][gamma*4+gamma1][v3] = qcd_CADD( block[8][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                ...
                //////////////// delta_plus //////////////////////////////////////////////////////
                        ...
                        block[9][gamma*4+gamma1][v3] = qcd_CSUB( block[9][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][beta1][a][b1] )
                                                ,uprop->D[v][beta][alpha1][b][a1] ), dprop->D[v][gamma][gamma1][c][c1] ), 1./3.));
                        
                        block[9][gamma*4+gamma1][v3] = qcd_CADD( block[9][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                ...
                //////////////// delta_zero ////////////////////////
                        block[10][gamma*4+gamma1][v3] = qcd_CSUB( block[10][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[10][gamma*4+gamma1][v3] = qcd_CADD( block[10][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                ...
                ////////// delta_minus ///////////////////////////////
                        block[11][gamma*4+gamma1][v3] = qcd_CSUB( block[11][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
                                                ,dprop->D[v][beta][beta1][b][b1] ), dprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[11][gamma*4+gamma1][v3] = qcd_CADD( block[11][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
                ...
                ////// sigma_star_plus ////////////////////////////
                        block[12][gamma*4+gamma1][v3] = qcd_CSUB( block[12][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][beta1][a][b1] )
                                                ,uprop->D[v][beta][alpha1][b][a1] ), sprop->D[v][gamma][gamma1][c][c1] ), 1./3.));
                        
                        block[12][gamma*4+gamma1][v3] = qcd_CADD( block[12][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        block[12][gamma*4+gamma1][v3] = qcd_CSUB( block[12][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
                        ...
                        block[12][gamma*4+gamma1][v3] = qcd_CSUB( block[12][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
                ...
                ///////////////////// sigma_star_zero ///////////////
                        block[13][gamma*4+gamma1][v3] = qcd_CADD( block[13][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][beta1][a][b1] )
                                                ,uprop->D[v][beta][gamma1][b][c1] ), dprop->D[v][gamma][alpha1][c][a1] ), 2./3.));
                ...
                /////////////////////// sigma_star_minus /////////////
                        block[14][gamma*4+gamma1][v3] = qcd_CSUB( block[14][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
                                                ,dprop->D[v][beta][alpha1][b][a1] ), sprop->D[v][gamma][gamma1][c][c1] ), 1./3.));
                        
                        block[14][gamma*4+gamma1][v3] = qcd_CADD( block[14][gamma*4+gamma1][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
                ...
                //////////////////////// ksi_star_zero ////////////////////////
                        block[15][gamma*4+gamma1][v3] = qcd_CSUB( block[15][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
                                                ,uprop->D[v][beta][beta1][b][b1] ), sprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[15][gamma*4+gamma1][v3] = qcd_CADD( block[15][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
                                                ,uprop->D[v][beta][beta1][b][b1] ), sprop->D[v][gamma][gamma1][c][c1] ));
                //////////////////////////////////////////////////////////////
                        
                //////////////////////// ksi_star_minus ////////////////////////
                        block[16][gamma*4+gamma1][v3] = qcd_CSUB( block[16][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
                                                ,dprop->D[v][beta][beta1][b][b1] ), sprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[16][gamma*4+gamma1][v3] = qcd_CADD( block[16][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
                ...
                ////////// omega ///////////////////////////////////////////////////
                        ...
                        block[17][gamma*4+gamma1][v3] = qcd_CSUB( block[17][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
                                                ,sprop->D[v][beta][beta1][b][b1] ), sprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[17][gamma*4+gamma1][v3] = qcd_CADD( block[17][gamma*4+gamma1][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[icg][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][beta1][a][b1] )
