...
int octet_J32(qcd_propagator *uprop, qcd_propagator *dprop, qcd_propagator *sprop, qcd_propagator *cprop, qcd_geometry *geo,
               ...
               for(int cc1=0;cc1<6;cc1++)
               {
                  ...
                  {          
                     ...
                     c1 = qcd_EPS[cc2][2];
                        ...
                        ////////// proton ////////////////////
                        block[0][gamma*4+gamma1][9][v3] = qcd_CSUB( block[0][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[0][gamma*4+gamma1][9][v3] = qcd_CADD( block[0][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        ////////// neutron ////////////////////
                        block[1][gamma*4+gamma1][9][v3] = qcd_CSUB( block[1][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[1][gamma*4+gamma1][9][v3] = qcd_CADD( block[1][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        ///////// lambda ////////////////////
                        block[2][gamma*4+gamma1][9][v3] = qcd_CADD( block[2][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][gamma1][a][c1] )
                        ...
                        block[2][gamma*4+gamma1][9][v3] = qcd_CSUB( block[2][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
                        ...
                        block[3][gamma*4+gamma1][9][v3] = qcd_CSUB( block[3][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][gamma1][a][c1] )
                                                ,sprop->D[v][beta][beta1][b][b1] ), uprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[3][gamma*4+gamma1][9][v3] = qcd_CADD( block[3][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        block[4][gamma*4+gamma1][9][v3] = qcd_CSUB( block[4][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][gamma1][a][c1] )
                        ...
                        block[4][gamma*4+gamma1][9][v3] = qcd_CADD( block[4][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        block[5][gamma*4+gamma1][9][v3] = qcd_CSUB( block[5][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
                                                ,sprop->D[v][beta][beta1][b][b1] ), dprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[5][gamma*4+gamma1][9][v3] = qcd_CADD( block[5][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        //////////// ksi_zero ///////////////////////
                        block[6][gamma*4+gamma1][9][v3] = qcd_CSUB( block[6][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[6][gamma*4+gamma1][9][v3] = qcd_CADD( block[6][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[7][gamma*4+gamma1][9][v3] = qcd_CSUB( block[7][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
                                                ,dprop->D[v][beta][beta1][b][b1] ), sprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[7][gamma*4+gamma1][9][v3] = qcd_CADD( block[7][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
