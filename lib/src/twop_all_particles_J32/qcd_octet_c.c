...
int octet_c_J32(qcd_propagator *uprop, qcd_propagator *dprop, qcd_propagator *sprop, qcd_propagator *cprop, qcd_geometry *geo,
               ...
               for(int cc1=0;cc1<6;cc1++)
               {
                  ...
                  {          
                     ...
                     c1 = qcd_EPS[cc2][2];
                        ...
                        ///////// lambda_c ////////////////////
                        block[18][gamma*4+gamma1][9][v3] = qcd_CADD( block[18][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[18][gamma*4+gamma1][9][v3] = qcd_CSUB( block[18][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[19][gamma*4+gamma1][9][v3] = qcd_CSUB( block[19][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][gamma1][a][c1] )
                                                ,cprop->D[v][beta][beta1][b][b1] ), uprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[19][gamma*4+gamma1][9][v3] = qcd_CADD( block[19][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        block[20][gamma*4+gamma1][9][v3] = qcd_CSUB( block[20][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][gamma1][a][c1] )
                        ...
                        block[20][gamma*4+gamma1][9][v3] = qcd_CADD( block[20][gamma*4+gamma1][9][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),uprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        block[21][gamma*4+gamma1][9][v3] = qcd_CSUB( block[21][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
                                                ,cprop->D[v][beta][beta1][b][b1] ), dprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[21][gamma*4+gamma1][9][v3] = qcd_CADD( block[21][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
                        ...
                        //////////// ksi_plus_plus_c_c ///////////////////////
                        block[22][gamma*4+gamma1][9][v3] = qcd_CSUB( block[22][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[22][gamma*4+gamma1][9][v3] = qcd_CADD( block[22][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                        ...
                        block[23][gamma*4+gamma1][9][v3] = qcd_CSUB( block[23][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),cprop->D[v][alpha][gamma1][a][c1] )
                                                ,dprop->D[v][beta][beta1][b][b1] ), cprop->D[v][gamma][alpha1][c][a1] ));
                        
                        block[23][gamma*4+gamma1][9][v3] = qcd_CADD( block[23][gamma*4+gamma1][9][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
                                                cg5cg5b_val[9][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),cprop->D[v][alpha][alpha1][a][a1] )
