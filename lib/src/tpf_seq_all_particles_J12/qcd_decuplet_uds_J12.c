	  ...
	  for(int inz =0 ; inz < nz_counter[i*3+j] ; inz++){
	    ...
	    for(int cc1=0;cc1<6;cc1++)
			...
			////////// Upart ////////////////                                                                                                                                           
                        ...
                        block_Upart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Upart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE(
...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  U_part_uds[mu][nu][itmom] = qcd_CADD( Term3_U[mu][nu] , Term6_U[mu][nu] ) ;
		  //////////// dpart /////////////
		  ...
		  D_part_uds[mu][nu][itmom] = qcd_CADD( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
		  //////////// spart /////////////
		  ...
		  S_part_uds[mu][nu][itmom] = qcd_CADD( Term3_S[mu][nu] , Term6_S[mu][nu] ) ;
