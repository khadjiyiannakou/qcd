	  ...
	  for(int inz =0 ; inz < nz_counter[i*3+j] ; inz++){
	    ...
	    for(int cc1=0;cc1<6;cc1++)
			...
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 ...
			                                 ,sprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][alpha][beta1][a][b1] ),1./3.));
			...
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 ...
			                                 ,sprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][alpha][alpha1][a][a1] ),1./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,sprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][beta][beta1][b][b1] ),1./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,sprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][beta][alpha1][b][a1] ),1./3.));
			
			// *2
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][beta1][b][b1] )
			                                 ,sprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][alpha][gamma1][a][c1] ),2./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][gamma1][b][c1] )
			                                 ,sprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][alpha][beta1][a][b1] ),2./3.));
			...
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 ...
			                                 ,sprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][beta][beta1][b][b1] ),2./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][beta][beta1][b][b1] ),2./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][beta][alpha1][b][a1] ),2./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][beta][alpha1][b][a1] ), seq_dprop->D[v][gamma][beta1][c][b1] ),2./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_dprop->D[v][gamma][alpha1][c][a1] ),2./3.));
			
			// *4
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][beta][gamma1][b][c1] ),4./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][beta][beta1][b][b1] ),4./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_dprop->D[v][gamma][gamma1][c][c1] ),4./3.));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),sprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][beta][gamma1][b][c1] ), seq_dprop->D[v][gamma][beta1][c][b1] ),4./3.));
			...
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,dprop->D[v][beta][alpha1][b][a1] ), seq_sprop->D[v][gamma][gamma1][c][c1] ),1./3.));
			...
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_sprop->D[v][gamma][gamma1][c][c1] ),1./3.));
			
			// *2
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][beta1][b][b1] )
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_sprop->D[v][alpha][gamma1][a][c1] ),2./3.));
			...
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_sprop->D[v][gamma][alpha1][c][a1] ),2./3.));
			...
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][gamma1][b][c1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_sprop->D[v][alpha][alpha1][a][a1] ),4./3.));
			
			
			block_Spart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Spart[gamma][gamma1][i*3+j][v3] ,qcd_CSCALE(qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][beta1][b][b1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_sprop->D[v][alpha][alpha1][a][a1] ),4./3.));
...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  D_part_sigmaSM[mu][nu][itmom] = qcd_CADD( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
		  ...
		  S_part_sigmaSM[mu][nu][itmom] = qcd_CADD( Term3_S[mu][nu] , Term6_S[mu][nu] ) ;
