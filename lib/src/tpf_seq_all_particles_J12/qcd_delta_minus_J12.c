	  ...
	  for(int inz =0 ; inz < nz_counter[i*3+j] ; inz++){
	    ...
	    for(int cc1=0;cc1<6;cc1++)
			...
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 ...
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][alpha][gamma1][a][c1] ));
			...
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 ...
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][alpha][beta1][a][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][alpha1][b][a1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][alpha][gamma1][a][c1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][gamma1][b][c1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][alpha][alpha1][a][a1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][alpha1][b][a1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][alpha][beta1][a][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][beta][beta1][b][b1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][alpha][alpha1][a][a1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][beta][gamma1][b][c1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][gamma][alpha1][c][a1] ), seq_dprop->D[v][beta][beta1][b][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][beta][gamma1][b][c1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][gamma][beta1][c][b1] ), seq_dprop->D[v][beta][alpha1][b][a1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][beta][beta1][b][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,dprop->D[v][gamma][gamma1][c][c1] ), seq_dprop->D[v][beta][alpha1][b][a1] ));

			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,dprop->D[v][beta][alpha1][b][a1] ), seq_dprop->D[v][gamma][gamma1][c][c1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][beta][alpha1][b][a1] ), seq_dprop->D[v][gamma][beta1][c][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_dprop->D[v][gamma][gamma1][c][c1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][gamma1][a][c1] )
			                                 ,dprop->D[v][beta][beta1][b][b1] ), seq_dprop->D[v][gamma][alpha1][c][a1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CSUB( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][alpha1][a][a1] )
			                                 ,dprop->D[v][beta][gamma1][b][c1] ), seq_dprop->D[v][gamma][beta1][c][b1] ));
			
			block_Dpart[gamma][gamma1][i*3+j][v3] = qcd_CADD( block_Dpart[gamma][gamma1][i*3+j][v3] ,qcd_CMUL(qcd_CMUL(qcd_CMUL(qcd_CSCALE( 
			                                 cg5cg5b_val[i*3+j][inz], qcd_SGN_EPS[cc1]*qcd_SGN_EPS[cc2]),dprop->D[v][alpha][beta1][a][b1] )
			                                 ,dprop->D[v][beta][gamma1][b][c1] ), seq_dprop->D[v][gamma][alpha1][c][a1] ));
...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  D_part_deltaM[mu][nu][itmom] = qcd_CADD( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
