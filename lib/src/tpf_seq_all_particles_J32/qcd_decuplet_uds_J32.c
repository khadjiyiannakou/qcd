...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  U_part_uds[mu][nu][itmom] = qcd_CSUB( Term3_U[mu][nu] , Term6_U[mu][nu] ) ;
		  //////////// dpart /////////////
		  ...
		  D_part_uds[mu][nu][itmom] = qcd_CSUB( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
		  //////////// spart /////////////
		  ...
		  S_part_uds[mu][nu][itmom] = qcd_CSUB( Term3_S[mu][nu] , Term6_S[mu][nu] ) ;
