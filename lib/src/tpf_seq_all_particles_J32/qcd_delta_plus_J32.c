...
int tpf_delta_plus_J32(qcd_propagator *uprop, qcd_propagator *dprop, qcd_propagator *sprop, qcd_propagator *seq_uprop, qcd_propagator *seq_dprop,
...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
        ...
        Term3_U[mu][nu] = qcd_CSCALE( qcd_CADD(qcd_CADD( Upart_temp[mu][nu][0*3+0], Upart_temp[mu][nu][1*3+1] ) , Upart_temp[mu][nu][2*3+2] ) , 1./3. );
                  ...
                  U_part_deltaP[mu][nu][itmom] = qcd_CSUB( Term3_U[mu][nu] , Term6_U[mu][nu] ) ;
        ...
        Term3_D[mu][nu] = qcd_CSCALE( qcd_CADD(qcd_CADD( Dpart_temp[mu][nu][0*3+0], Dpart_temp[mu][nu][1*3+1] ) , Dpart_temp[mu][nu][2*3+2] ) , 1./3. );
                  ...
                  D_part_deltaP[mu][nu][itmom] = qcd_CSUB( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
