...
int tpf_sigma_star_zero_J32(qcd_propagator *uprop, qcd_propagator *dprop, qcd_propagator *sprop, qcd_propagator *seq_uprop, qcd_propagator *seq_dprop,
	   ...
	   for(int i = 0 ; i < 3 ; i++)
		...
		for(int nu = 0 ; nu < 4 ; nu++)
		  for(int lu = 0 ; lu < 4 ; lu++){
		    ////////////// upart//////////////
		    TermJ32_U[0][mu][nu] = qcd_CADD(TermJ32_U[0][mu][nu] , qcd_CMUL( qcd_GAMMA_J32[0][mu][lu] , qcd_CSUB(Upart_temp[lu][nu][1*3+0] , Upart_temp[lu][nu][0*3+1] ) ) );
		    TermJ32_U[1][mu][nu] = qcd_CADD(TermJ32_U[1][mu][nu] , qcd_CMUL( qcd_GAMMA_J32[1][mu][lu] , qcd_CSUB(Upart_temp[lu][nu][2*3+0] , Upart_temp[lu][nu][0*3+2] ) ) );
		    TermJ32_U[2][mu][nu] = qcd_CADD(TermJ32_U[2][mu][nu] , qcd_CMUL( qcd_GAMMA_J32[2][mu][lu] , qcd_CSUB(Upart_temp[lu][nu][2*3+1] , Upart_temp[lu][nu][1*3+2] ) ) );
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  Term6_U[mu][nu] = qcd_CSCALE( qcd_CADD(qcd_CADD(TermJ32_U[0][mu][nu] , TermJ32_U[1][mu][nu] ) , TermJ32_U[2][mu][nu] ) , 1./6.) ;
		  U_part_sigmaSZ[mu][nu][itmom] = qcd_CSUB( Term3_U[mu][nu] , Term6_U[mu][nu] ) ;
		  ...
		  D_part_sigmaSZ[mu][nu][itmom] = qcd_CSUB( Term3_D[mu][nu] , Term6_D[mu][nu] ) ;
		  //////////// spart /////////////
		  ...
		  S_part_sigmaSZ[mu][nu][itmom] = qcd_CSUB( Term3_S[mu][nu] , Term6_S[mu][nu] ) ;
