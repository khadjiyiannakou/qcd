...
int tpf_delta_plus_plus_J32(qcd_propagator *uprop, qcd_propagator *dprop, qcd_propagator *sprop, qcd_propagator *seq_uprop, 
...
//               corr=qcd_CADD(corr, qcd_CMUL(block[v3],C2));
		...
		for(int nu = 0 ; nu < 4 ; nu++){
		  ...
		  U_part_deltaPP[mu][nu][itmom] = qcd_CSUB( Term3_U[mu][nu] , Term6_U[mu][nu] ) ;
