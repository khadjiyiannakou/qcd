  ...
  ///////////////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////// start contractions /////////////////////////////////////////////////////////////
	 ...
	 for(int iparticle = 0 ; iparticle < MAX_PARTICLES_2 ; iparticle++)
      ...
      octet_final6(&uprop, &dprop, &sprop, &cprop, &geo, block, t, nz_counter , Pcg5cg5b_ind , Pcg5cg5b_val);
      if(myid == 0) printf("finish octet_final6\n");

      decuplet_final4(&uprop, &dprop, &sprop, &cprop, &geo, block, t, nz_counter , Pcg5cg5b_ind , Pcg5cg5b_val);
