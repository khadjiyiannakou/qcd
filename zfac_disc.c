...
int main(int argc,char* argv[])
{
   ...
   char vfun_name[qcd_MAX_STRING_LENGTH];     // output file name, local scalar density vertex function
   ...
   strcpy(vfun_name,qcd_getParam("<vertex_function_disc_name>",params,params_len));
